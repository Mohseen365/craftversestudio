...
export default async function AdminDashboardPage() {
  ...
  const [revenueToday, revenueMonth, ordersMonth, topProduct, pending, inProduction] =
    await Promise.all([
  ...
  const stats = [
    { label: "Revenue today", value: formatPrice(revenueToday._sum.total ?? 0) },
    { label: "Revenue this month", value: formatPrice(revenueMonth._sum.total ?? 0) },
